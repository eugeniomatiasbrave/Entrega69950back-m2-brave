...
//import validateCreateProduct from '../middlewares/validators/productValidator.js'; // A solucionar...
...
class ProductsRouter extends BaseRouter {
    init() {
        ...
        this.post('/', ['ADMIN'], executePolicies(['ADMIN']), uploader.array('thumbnail', 3), productsController.createProduct);
